...
export function Sidebar({ isOpen }: SidebarProps): JSX.Element {
  ...
  return (
    <aside
      className={`fixed left-0 top-16 z-40 h-[calc(100vh-4rem)] transform border-r border-slate-200 bg-white transition-transform duration-200 ease-in-out dark:border-slate-700 dark:bg-slate-900 ${
